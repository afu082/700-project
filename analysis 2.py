...
import numpy as np
 ...
 # Import plotter_copy and run the convert function
refractive_index_air = 1
refractive_index_lens = 1.5
#equation_inner_lens = [0, 0, -0.25, 0, 1, -10, 10]
...
# # Define the function to calculate initial_candela_values
# def calculate_initial_candela_values():
#     # Generate initial_angles list
#     initial_angles = list(range(0, 91, 1))

#     # Convert angles to radians and compute cos(x)
#     initial_candela_values = [math.cos(math.radians(angle)) for angle in initial_angles]

#     return initial_angles, initial_candela_values

# initial_angles, initial_candela_values = calculate_initial_candela_values()

plotter_copy.convert(refractive_index_air, refractive_index_lens, equation_inner_lens, equation_outer_lens)
...
def extract_candelas_by_angle(angle_candela_map, bins):
    ...
    # Create a dictionary for bin labels
...
bins = range(0, 91, 5)  # Define your bins
...
print("Midpoints Exit:", midpoints_exit)
print("Average Exit Candelas:", average_exit_candelas)
print("Midpoint Exit Candela Map:", midpoint_exit_candela_map)
